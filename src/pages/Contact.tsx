            ...
            <div className="lg:col-span-1 space-y-12">
              ...
              <div>
                ...
                <div className="mt-8 flex items-center gap-3 border-t border-gray-200 pt-6">
                  <a
                    href="https://wa.me/8618926541701"
                    target="_blank"
                    rel="noreferrer"
                    aria-label="WhatsApp"
                    className="flex h-10 w-10 items-center justify-center border border-gray-200 bg-white text-accent transition-colors hover:border-accent hover:bg-accent hover:text-white"
                  >
                  ...
                  <a
                    href="https://linkedin.com/in/lee-lynn-b173a075"
                    target="_blank"
                    rel="noreferrer"
                    aria-label="LinkedIn"
                    className="flex h-10 w-10 items-center justify-center border border-gray-200 bg-white text-accent transition-colors hover:border-accent hover:bg-accent hover:text-white"
